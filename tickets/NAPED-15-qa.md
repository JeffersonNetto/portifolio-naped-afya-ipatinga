...
- Funcional: abrir todos os itens de menu, filtro/busca, página de ação, mês, projeto, evidência, manual e Receita; testar estado vazio.
...
- Verificar caminhos no domínio `jeffersonnetto.github.io` com prefixo do repo e impressão do manual se houver PDF.
